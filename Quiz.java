...
public class Quiz extends JFrame implements ActionListener
{
   ...
   Quiz(String name)
   {
      ...
      questions[0][0] = "Which is used to find and fix bugs in the Java programs.?";
        ...
        opt3.setBounds(150, 600, 700, 30);
        opt3.setBackground(Color.WHITE);
        opt3.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt3);
        
        opt4 =  new JRadioButton();
        opt4.setBounds(150, 640, 700, 30);
        ...
        lifeline.setBounds(900, 600, 180, 30);
        lifeline.setFont(new Font("Tahoma", Font.PLAIN, 22));
        lifeline.setBackground(new Color(135, 206, 235));
        ...
        submit.setBounds(900, 650, 180, 30);
   ...
   public void paint(Graphics g)
   {
       ...
       if(timer > 0)
       {
           g.drawString(time, 908, 470);
           
       }
       else
       {
          g.drawString("Times up!", 905, 507);
